...
import fr.insalyon.creatis.vip.simulationgui.client.gui.SimulationGUIControlBox;
import fr.insalyon.creatis.vip.simulationgui.client.gui.SimulationGUIControlBoxModel;
               ...
               private Data3D multiparsor(Data3D [][]object)
                {
                  ...
                  //  int tailleI=0;
                    ...
                    for(Data3D d[] :object)
                    {
                       ...
                       for(Data3D d1:d) 
                       {
                           if(d1.isEnable()&&d1.getColors()!=null)tailleC+=d1.getColors().length;
                           if(d1.isEnable()&&d1.getVertices()!=null)tailleV+=d1.getVertices().length;
                           if(d1.isEnable()&&d1.getColors()!=null)tailleN+=d1.getNormals().length;
