...
- on the first connection, the admin password must be initialized. The default admin email is `admin@vip-local-test.local`. Use the "forgot password" feature and get the code in the logs.
