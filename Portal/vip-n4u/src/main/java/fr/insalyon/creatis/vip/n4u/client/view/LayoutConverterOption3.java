 ...
 */
public class LayoutConverterOption3 extends AbstractFormLayout {
     ...
     * @param height
     */
    public LayoutConverterOption3(int width, String height) {
        super(width, height);
        configure();
    }
     ...
     * @param height
     */
    public LayoutConverterOption3(String width, String height) {
        super(width, height);
        configure();
    }
