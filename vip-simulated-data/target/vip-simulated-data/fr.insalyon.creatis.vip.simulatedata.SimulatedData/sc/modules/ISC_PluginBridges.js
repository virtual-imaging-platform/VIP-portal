...
,isc.A.$n6=function isc_BrowserPlugin__showDragMask(){if(!this.usePlaceholderDragMask)return this.Super("$n6",arguments);var _1=this.getPluginHandle();if(_1){_1.style.visibility="hidden";if(!this.$41t)this.$41t=this.createDragPlaceholder();if(this.$41t){isc.addProperties(this.$41t,{$k9:this,getTarget:function(){return this.$k9}});this.$41t.setRect(this.getPageRect());this.$41t.show()}}}
,isc.A.$n7=function isc_BrowserPlugin__hideDragMask(){if(!this.usePlaceholderDragMask)return this.Super("$n7",arguments);var _1=this.getPluginHandle();if(_1){_1.style.visibility="inherit";if(this.$41t)this.$41t.hide()}}
...
,isc.A.idForName=function isc_c_Applet_idForName(_1){if(_1&&_1.endsWith("$41u"))return _1.substring(0,_1.length-7)}
,isc.A.startJavaEventProxy=function isc_c_Applet_startJavaEventProxy(){if(this.eventProxyApplet)return;this.eventProxyApplet=isc.Applet.create({top:-1000,width:10,height:10,autoDraw:false,useJavaEventProxy:false,useDragMask:true,params:{debug:this.debug,useEventMasks:this.useEventMasks,appletScanInterval:this.appletScanInterval},$n6:function(){var _1=this.getPluginHandle();if(_1)_1.showDragMask()},$n7:function(){var _1=this.getPluginHandle();if(_1)_1.hideDragMask()},ID:"isc_eventProxyApplet",archive:isc.Page.getURL("[HELPERS]isomorphic_applets.jar"),code:"com/isomorphic/applets/ISCEventProxy.class"});this.eventProxyApplet.draw()}
...
_1.append("</object>")}
return _1.toString()}
,isc.A.getPluginID=function isc_Applet_getPluginID(){if(!this.name)this.name=this.getID()+"$41u";return this.name}
...
,isc.A.getPluginID=function isc_Flashlet_getPluginID(){return this.getID()+"$41w"}
...
);isc.B._maxIndex=isc.C+4;isc.ClassFactory.defineClass("SVG","BrowserPlugin");isc.A=isc.SVG.getPrototype();isc.A.useNativeMask=true;isc.A.pluginsPage="http://www.adobe.com/svg/viewer/install/";isc.A.src=isc.Page.getHelperDir()+"svgCanvas.svg";isc.A=isc.SVG;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.register=function isc_c_SVG_register(_1){var _2=_1.getTarget();var _3=_2.getOwnerDocument();var _4=this.getSVGCanvas(_3);_4.addProperties({svgElement:_2,svgDocument:_3,svgDoc:_3,svgRoot:_3.getRootElement()});var _5=_4.getPluginHandle();if(_5["window"])_5["window"].svgCanvas=_4;if(isc.isA.Function(_4.initSVG))_4.initSVG();else if(isc.isA.Function(_4.initsvg))_4.initsvg();if(_4.useNativeMask)_4.$41x();if(_4.$41y)_4.showNativeMask()}
...
,isc.A.mouseOut=function isc_SVG_mouseOut(){if(this.useNativeMask){this.hideNativeMask();this.Super("$n7")}}
,isc.A.$n6=function isc_SVG__showDragMask(){if(this.useNativeMask)this.showNativeMask();else this.Super("$n6")}
,isc.A.$n7=function isc_SVG__hideDragMask(){if(this.useNativeMask)this.hideNativeMask();else this.Super("$n7")}
...
,isc.A.$41x=function isc_SVG__makeSVGEventMask(){this.$41z=this.svgDoc.createElement("rect");this.$410=this.getID()+"_SVGEventMask";var _1={id:this.$410,x:"-1073741823",y:"-1073741823",width:"2147483647",height:"2147483647",opacity:"0.0",visibility:"hidden",onmousemove:"svgCanvas.handleSVGEvent(evt)",onmouseup:"svgCanvas.handleSVGEvent(evt)",onmouseout:"svgCanvas.handleSVGEvent(evt)",onclick:"svgCanvas.handleSVGEvent(evt)",oncontextmenu:"svgCanvas.handleSVGEvent(evt)"};for(var _2 in _1)this.$41z.setAttribute(_2,_1[_2]);this.svgRoot.appendChild(this.$41z)}
,isc.A.setZIndex=function isc_SVG_setZIndex(){}
,isc.A.showNativeMask=function isc_SVG_showNativeMask(){if(!this.svgDoc){this.logWarn("showNativeMask called before SVG.register() - deferring until SVG.register()");this.$41y=true;return}
if(this.$41z){this.svgRoot.removeChild(this.$41z);this.svgRoot.appendChild(this.$41z)}else{this.$41x()}
this.$41z.setAttribute("visibility","visible")}
,isc.A.hideNativeMask=function isc_SVG_hideNativeMask(){if(this.$41z)this.$41z.setAttribute("visibility","hidden")}
...
,isc.A.destroy=function isc_SVG_destroy(){if(this.$41z)delete this.$41z;var _1=this.getPluginHandle();if(_1&&_1["window"])delete _1["window"].svgCanvas;this.Super("destroy")}
...
,isc.A.getPluginID=function isc_ActiveXControl_getPluginID(){if(!this.id)this.id=this.getID()+"$411";return this.id}
