...
//            list.add(mri);
            ...
            List<fr.cnrs.i3s.neusemstore.provenance.expsummaries.dto.SimulatedData> beans = expeSummary.generateBeans(summaries);
            ...
            for(fr.cnrs.i3s.neusemstore.provenance.expsummaries.dto.SimulatedData sd : beans){
                ...
                ssd.setParameters(sd.getParameters());
                ssd.setModel(sd.getModel());
